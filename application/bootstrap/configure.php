...
define('DIRNAME_VAR', 'var');
define('DIRNAME_LOGS', 'logs');
define('DIRNAME_CACHE', 'cache');

define('DIR_VAR', DIR_BASE . '/' . DIRNAME_VAR);
define('DIR_LOGS', DIR_VAR . '/' . DIRNAME_LOGS);
define('DIR_CACHE', DIR_VAR . '/' . DIRNAME_CACHE);
...
define('DIRNAME_JAVASCRIPT_TEMPLATE', 'js_template');
...
define('DIRNAME_FILES', 'files');
define('REL_DIR_FILES_DEFAULT', '/' . DIRNAME_FILES);
define('REL_DIR_FILES_INCOMING', '/incoming');
define('REL_DIR_FILES_THUMBNAILS', '/thumbnails');
define('DIRNAME_EXTERNAL_BLOCK_TEMPLATES', 'block_templates');
 ...
 * ----------------------------------------------------------------------------
 */
define('DIR_BASE_CORE', realpath(dirname(__FILE__) . '/../../concrete'));
