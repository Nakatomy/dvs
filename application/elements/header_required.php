...
<script type="text/javascript">
    ...
    var CCM_REL = "<?php echo Core::make('token')->generate('common'); ?>";
    var CCM_REQUEST_PROTOCOL = <?php echo var_export(Request::getInstance()->isSecure()); ?>;
</script>
...
if (Config::get("concrete.maintenance_mode") && file_exists(DIR_BASE . '/application/css/src/maintenance.css')) {
    View::getInstance()->addHeaderItem('<link href="/application/css/src/maintenance.css" rel="stylesheet" type="text/css" media="all">');
}
